    ...
    return await Promise.all(documents.map(async (doc) => {
      try {
        ...
        if (typeof doc.challenger_id === 'string' && chalId) {
          ...
          chalObj = { $id: chalId, username: chalUser.username, name: chalUser.name, avatar: chalUser.avatar };
        }
        ...
        if (typeof doc.opponent_id === 'string' && oppId) {
          ...
          oppObj = { $id: oppId, username: oppUser.username, name: oppUser.name, avatar: oppUser.avatar };
        }
